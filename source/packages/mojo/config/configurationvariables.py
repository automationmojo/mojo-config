...
class CONFIGURATION_MAPS:
    ...
    RUNTIME_CONFIGURATION_MAP = MergeMap(MOJO_CONFIG_DEFAULTS.DEFAULT_CONFIGURATION)
...
class MOJO_CONFIG_VARNAMES:
    ...
    MJR_CONFIG_STORAGE_URI = "MJR_CONFIG_STORAGE_URI"
...
class MOJO_CONFIG_VARIABLES(MOJO_PRESENCE_VARIABLES):
    ...
    MJR_CONFIG_REQUIRE_RUNTIME = MOJO_CONFIG_DEFAULTS.MJR_CONFIG_REQUIRE_RUNTIME
    MJR_CONFIG_REQUIRE_TOPOLOGY = MOJO_CONFIG_DEFAULTS.MJR_CONFIG_REQUIRE_TOPOLOGY

    MJR_CONFIG_STORAGE_URI = MOJO_CONFIG_DEFAULTS.MJR_CONFIG_STORAGE_URI
...
def resolve_configuration_variables():
    ...
    ctx.insert(ContextPaths.PRESENCE_CONFIG_DIRECTORY, MOJO_CONFIG_VARIABLES.MJR_CONFIG_DIRECTORY)


    if MOJO_CONFIG_VARNAMES.MJR_CONFIG_STORAGE_URI in environ:
        MOJO_CONFIG_VARIABLES.MJR_CONFIG_STORAGE_URI = environ[MOJO_CONFIG_VARNAMES.MJR_CONFIG_STORAGE_URI]
    ctx.insert(ContextPaths.CONFIG_STORAGE_URI, MOJO_CONFIG_VARIABLES.MJR_CONFIG_STORAGE_URI)
    ...
    elif MOJO_CONFIG_DEFAULTS.MJR_CONFIG_REQUIRE_CREDENTIALS and not MOJO_CONFIG_VARIABLES.MJR_CONFIG_CREDENTIAL_FILES:
        MOJO_CONFIG_VARIABLES.MJR_CONFIG_USE_CREDENTIALS = True
    ...
    elif MOJO_CONFIG_DEFAULTS.MJR_CONFIG_REQUIRE_LANDSCAPE and not MOJO_CONFIG_VARIABLES.MJR_CONFIG_LANDSCAPE_FILES:
        MOJO_CONFIG_VARIABLES.MJR_CONFIG_USE_LANDSCAPE = True
    ...
    elif MOJO_CONFIG_DEFAULTS.MJR_CONFIG_REQUIRE_RUNTIME and not MOJO_CONFIG_VARIABLES.MJR_CONFIG_RUNTIME_FILES:
        MOJO_CONFIG_VARIABLES.MJR_CONFIG_USE_RUNTIME = True
