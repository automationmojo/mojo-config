...
def resolve_configuration_variables():
    ...
    MOJO_CONFIG_VARIABLES.MJR_USER_CONFIG_SOURCE = os.path.join(
        MOJO_CONFIG_VARIABLES.MJR_HOME_DIRECTORY, "config")
    if MOJO_CONFIG_VARNAMES.MJR_USER_CONFIG_SOURCE in environ:
        MOJO_CONFIG_VARIABLES.MJR_USER_CONFIG_SOURCE = environ[MOJO_CONFIG_VARNAMES.MJR_USER_CONFIG_SOURCE]

    MOJO_CONFIG_VARIABLES.MJR_USER_CONFIG_NAME = "user-runtime"
    if MOJO_CONFIG_VARNAMES.MJR_USER_CONFIG_NAME in environ:
        MOJO_CONFIG_VARIABLES.MJR_USER_CONFIG_NAME = environ[MOJO_CONFIG_VARNAMES.MJR_USER_CONFIG_NAME]

    MOJO_CONFIG_VARIABLES.MJR_USER_CONFIG_URI = os.path.join(
        MOJO_CONFIG_VARIABLES.MJR_USER_CONFIG_SOURCE,
        "{}.yaml".format(MOJO_CONFIG_VARIABLES.MJR_USER_CONFIG_NAME))
